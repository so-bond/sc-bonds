...
interface IDelegateInvestorManagement is IDelegateInvestorManagementInternal {
     ...
     */
    function setCustodianDelegate(address delegate) external;

    /**
     * @notice Unset the delegate for a custodian. The target custodian is the msg sender.
     */
    function unsetCustodianDelegate() external;
     ...
     * @param investor_ The investor address
     * @param delegator_ The actor to enable the investor as
     */
     ...
     * @param investor_ The investor address
     * @param delegator_ The actor to disable the investor as
     */

...
export interface BinaryHeapBytes32MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "at"
...
export interface BinaryHeapBytes32Mock extends BaseContract {
  connect(runner?: ContractRunner | null): BinaryHeapBytes32Mock;
  waitForDeployment(): Promise<this>;

  interface: BinaryHeapBytes32MockInterface;

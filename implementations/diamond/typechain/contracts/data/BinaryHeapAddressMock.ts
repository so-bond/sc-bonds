...
export interface BinaryHeapAddressMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "at"
...
export interface BinaryHeapAddressMock extends BaseContract {
  connect(runner?: ContractRunner | null): BinaryHeapAddressMock;
  waitForDeployment(): Promise<this>;

  interface: BinaryHeapAddressMockInterface;

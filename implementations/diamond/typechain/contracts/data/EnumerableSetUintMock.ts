...
export interface EnumerableSetUintMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "at"
...
export interface EnumerableSetUintMock extends BaseContract {
  connect(runner?: ContractRunner | null): EnumerableSetUintMock;
  waitForDeployment(): Promise<this>;

  interface: EnumerableSetUintMockInterface;

...
export interface ITradeInternalInterface extends Interface {
...
export interface ITradeInternal extends BaseContract {
  connect(runner?: ContractRunner | null): ITradeInternal;
  waitForDeployment(): Promise<this>;

  interface: ITradeInternalInterface;

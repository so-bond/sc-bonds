...
export interface IDiamondCutInternalInterface extends Interface {
...
export interface IDiamondCutInternal extends BaseContract {
  connect(runner?: ContractRunner | null): IDiamondCutInternal;
  waitForDeployment(): Promise<this>;

  interface: IDiamondCutInternalInterface;

...
export interface RegisterRoleManagementInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface RegisterRoleManagementInternal extends BaseContract {
  connect(runner?: ContractRunner | null): RegisterRoleManagementInternal;
  waitForDeployment(): Promise<this>;

  interface: RegisterRoleManagementInternalInterface;

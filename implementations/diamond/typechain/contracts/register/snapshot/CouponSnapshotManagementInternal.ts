...
export interface CouponSnapshotManagementInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface CouponSnapshotManagementInternal extends BaseContract {
  connect(runner?: ContractRunner | null): CouponSnapshotManagementInternal;
  waitForDeployment(): Promise<this>;

  interface: CouponSnapshotManagementInternalInterface;

...
export interface RedemptionInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface RedemptionInternal extends BaseContract {
  connect(runner?: ContractRunner | null): RedemptionInternal;
  waitForDeployment(): Promise<this>;

  interface: RedemptionInternalInterface;

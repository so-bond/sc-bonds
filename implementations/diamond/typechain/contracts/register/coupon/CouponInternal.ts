...
export interface CouponInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface CouponInternal extends BaseContract {
  connect(runner?: ContractRunner | null): CouponInternal;
  waitForDeployment(): Promise<this>;

  interface: CouponInternalInterface;

...
export interface InvestorManagementInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface InvestorManagementInternal extends BaseContract {
  connect(runner?: ContractRunner | null): InvestorManagementInternal;
  waitForDeployment(): Promise<this>;

  interface: InvestorManagementInternalInterface;

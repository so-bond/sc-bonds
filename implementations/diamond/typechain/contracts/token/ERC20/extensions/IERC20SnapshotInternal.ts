...
export interface IERC20SnapshotInternalInterface extends Interface {
...
export interface IERC20SnapshotInternal extends BaseContract {
  connect(runner?: ContractRunner | null): IERC20SnapshotInternal;
  waitForDeployment(): Promise<this>;

  interface: IERC20SnapshotInternalInterface;

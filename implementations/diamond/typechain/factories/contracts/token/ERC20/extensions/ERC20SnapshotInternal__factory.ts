...
} from "../../../../../contracts/token/ERC20/extensions/ERC20SnapshotInternal";
...
export class ERC20SnapshotInternal__factory {
  ...
  static createInterface(): ERC20SnapshotInternalInterface {
    return new Interface(_abi) as ERC20SnapshotInternalInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ERC20SnapshotInternal;
  }
}

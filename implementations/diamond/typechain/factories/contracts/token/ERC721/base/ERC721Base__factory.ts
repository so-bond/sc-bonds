...
import type {
  ERC721Base,
  ERC721BaseInterface,
} from "../../../../../contracts/token/ERC721/base/ERC721Base";
...
export class ERC721Base__factory {
  ...
  static createInterface(): ERC721BaseInterface {
    return new Interface(_abi) as ERC721BaseInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC721Base {
    return new Contract(address, _abi, runner) as unknown as ERC721Base;
  }
}

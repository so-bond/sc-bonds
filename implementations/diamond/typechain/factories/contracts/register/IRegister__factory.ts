...
import type {
  IRegister,
  IRegisterInterface,
} from "../../../contracts/register/IRegister";
...
export class IRegister__factory {
  ...
  static createInterface(): IRegisterInterface {
    return new Interface(_abi) as IRegisterInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IRegister {
    return new Contract(address, _abi, runner) as unknown as IRegister;
  }
}

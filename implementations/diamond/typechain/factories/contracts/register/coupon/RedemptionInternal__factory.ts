...
import type {
  RedemptionInternal,
  RedemptionInternalInterface,
} from "../../../../contracts/register/coupon/RedemptionInternal";
...
export class RedemptionInternal__factory {
  static readonly abi = _abi;
  static createInterface(): RedemptionInternalInterface {
    return new Interface(_abi) as RedemptionInternalInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RedemptionInternal {
    return new Contract(address, _abi, runner) as unknown as RedemptionInternal;
  }
}

...
} from "../../../../../contracts/register/coupon/redemption/IRedemption";
...
export class IRedemption__factory {
  ...
  static createInterface(): IRedemptionInterface {
    return new Interface(_abi) as IRedemptionInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IRedemption {
    return new Contract(address, _abi, runner) as unknown as IRedemption;
  }
}

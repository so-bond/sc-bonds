...
import type {
  CouponInternal,
  CouponInternalInterface,
} from "../../../../contracts/register/coupon/CouponInternal";
...
export class CouponInternal__factory {
  static readonly abi = _abi;
  static createInterface(): CouponInternalInterface {
    return new Interface(_abi) as CouponInternalInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CouponInternal {
    return new Contract(address, _abi, runner) as unknown as CouponInternal;
  }
}

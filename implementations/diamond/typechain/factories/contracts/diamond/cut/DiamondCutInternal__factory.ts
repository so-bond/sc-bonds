...
import type {
  DiamondCutInternal,
  DiamondCutInternalInterface,
} from "../../../../contracts/diamond/cut/DiamondCutInternal";
...
export class DiamondCutInternal__factory {
  static readonly abi = _abi;
  static createInterface(): DiamondCutInternalInterface {
    return new Interface(_abi) as DiamondCutInternalInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): DiamondCutInternal {
    return new Contract(address, _abi, runner) as unknown as DiamondCutInternal;
  }
}

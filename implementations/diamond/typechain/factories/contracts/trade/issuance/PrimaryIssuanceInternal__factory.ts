...
import type {
  PrimaryIssuanceInternal,
  PrimaryIssuanceInternalInterface,
} from "../../../../contracts/trade/issuance/PrimaryIssuanceInternal";
...
export class PrimaryIssuanceInternal__factory {
  static readonly abi = _abi;
  static createInterface(): PrimaryIssuanceInternalInterface {
    return new Interface(_abi) as PrimaryIssuanceInternalInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as PrimaryIssuanceInternal;
  }
}
